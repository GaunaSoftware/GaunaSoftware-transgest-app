...
const ROLE_PRESETS = {
  ...
  trafico: {
    ...
    editar: ["agenda","control_tower","pedidos","plan_diario","solicitudes","gestion_trafico","clientes","rutas","grupajes","palets","colaboradores","vehiculos","choferes","hojas_ruta","control_horario","avisos","mi_cuenta"],
  },
  administrativo: {
    ver: ["agenda","dashboard","pedidos","plan_diario","solicitudes","clientes","rutas","vehiculos","choferes","palets","facturacion","contabilidad","nominas","control_horario","informes","avisos","empresa","mi_cuenta"],
    editar: ["agenda","pedidos","plan_diario","solicitudes","clientes","palets","facturacion","control_horario","avisos","mi_cuenta"],
  },
  responsable_taller: {
    ver: ["app_mecanico","mi_cuenta"],
    editar: ["app_mecanico","mi_cuenta"],
  },
