...
const KNOWN_PLACES = {
  ...
  san_vicente_del_raspeig: { municipio:"San Vicente del Raspeig", provincia:"Alicante", pais:"Espana", lat:38.3964, lng:-0.5255 },
  sant_vicent_del_raspeig: { municipio:"San Vicente del Raspeig", provincia:"Alicante", pais:"Espana", lat:38.3964, lng:-0.5255 },
  san_vicente_raspeig: { municipio:"San Vicente del Raspeig", provincia:"Alicante", pais:"Espana", lat:38.3964, lng:-0.5255 },
  elche: { municipio:"Elche", provincia:"Alicante", pais:"Espana", lat:38.2699, lng:-0.7126 },
  elx: { municipio:"Elche", provincia:"Alicante", pais:"Espana", lat:38.2699, lng:-0.7126 },
  denia: { municipio:"Denia", provincia:"Alicante", pais:"Espana", lat:38.8408, lng:0.1057 },
  alcoy: { municipio:"Alcoy", provincia:"Alicante", pais:"Espana", lat:38.6987, lng:-0.4736 },
  alcoi: { municipio:"Alcoy", provincia:"Alicante", pais:"Espana", lat:38.6987, lng:-0.4736 },
  ibi: { municipio:"Ibi", provincia:"Alicante", pais:"Espana", lat:38.6253, lng:-0.5723 },
  villena: { municipio:"Villena", provincia:"Alicante", pais:"Espana", lat:38.6373, lng:-0.8657 },
  torrevieja: { municipio:"Torrevieja", provincia:"Alicante", pais:"Espana", lat:37.9787, lng:-0.6822 },
  orihuela: { municipio:"Orihuela", provincia:"Alicante", pais:"Espana", lat:38.0848, lng:-0.9440 },
  ...
  jerez_de_la_frontera: { municipio:"Jerez de la Frontera", provincia:"Cadiz", pais:"Espana", lat:36.6850, lng:-6.1261 },
  jerez_de_los_caballeros: { municipio:"Jerez de los Caballeros", provincia:"Badajoz", pais:"Espana", lat:38.3206, lng:-6.7726 },
  ...
  riba_roja_de_turia: { municipio:"Riba-roja de Turia", provincia:"Valencia", pais:"Espana", lat:39.5450, lng:-0.5708 },
  massanassa: { municipio:"Massanassa", provincia:"Valencia", pais:"Espana", lat:39.4082, lng:-0.3995 },
  massamagrell: { municipio:"Massamagrell", provincia:"Valencia", pais:"Espana", lat:39.5671, lng:-0.3358 },
  guadassuar: { municipio:"Guadassuar", provincia:"Valencia", pais:"Espana", lat:39.1866, lng:-0.4790 },
  cofrentes: { municipio:"Cofrentes", provincia:"Valencia", pais:"Espana", lat:39.2296, lng:-1.0602 },
  ...
  valderrobres: { municipio:"Valderrobres", provincia:"Teruel", pais:"Espana", lat:40.8734, lng:0.1551 },
  valderrobles: { municipio:"Valderrobres", provincia:"Teruel", pais:"Espana", lat:40.8734, lng:0.1551 },
  vall_de_roures: { municipio:"Valderrobres", provincia:"Teruel", pais:"Espana", lat:40.8734, lng:0.1551 },
  ...
  vicalvaro: { municipio:"Madrid", provincia:"Madrid", pais:"Espana", lat:40.3969, lng:-3.6093 },
  arganda_del_rey: { municipio:"Arganda del Rey", provincia:"Madrid", pais:"Espana", lat:40.3069, lng:-3.4477 },
  azuqueca: { municipio:"Azuqueca de Henares", provincia:"Guadalajara", pais:"Espana", lat:40.5657, lng:-3.2675 },
  azuqueca_de_henares: { municipio:"Azuqueca de Henares", provincia:"Guadalajara", pais:"Espana", lat:40.5657, lng:-3.2675 },
  pantoja: { municipio:"Pantoja", provincia:"Toledo", pais:"Espana", lat:40.0439, lng:-3.8359 },
  benidorm: { municipio:"Benidorm", provincia:"Alicante", pais:"Espana", lat:38.5411, lng:-0.1225 },
  segovia: { municipio:"Segovia", provincia:"Segovia", pais:"Espana", lat:40.9429, lng:-4.1088 },
  andorra: { municipio:"Andorra", provincia:"Teruel", pais:"Espana", lat:40.9766, lng:-0.4472 },
