...
if (!findings.length) {
  console.log("OK frontend alerts: no quedan alert() nativos en src");
  process.exit(0);
}

console.log(`Frontend alerts pendientes de migrar: ${findings.length}`);
...
if (process.env.STRICT_ALERT_AUDIT === "true") {
  process.exit(1);
}
