...
export const getPortalClienteResumen = () => apiFetch("/portal-cliente/resumen");
export const getPortalClientePedidos = () => apiFetch("/portal-cliente/pedidos");
export const getPortalClienteFacturas = () => apiFetch("/portal-cliente/facturas");
export const getPortalClienteFactura = (id) => apiFetch(`/portal-cliente/facturas/${encodeURIComponent(id)}`);
export const getPortalClienteSolicitudes = () => apiFetch("/portal-cliente/solicitudes");
export const getPortalClienteSolicitudEventos = (id) => apiFetch(`/portal-cliente/solicitudes/${encodeURIComponent(id)}/eventos`);
export const getPortalClienteDocumentosResumen = () => apiFetch("/portal-cliente/documentos-resumen");
export const getPortalClienteIntegracionManifest = () => apiFetch("/portal-cliente/integracion/manifest");
export const getPortalClienteIntegracionFeed = (days=90) => apiFetch(`/portal-cliente/integracion/feed?days=${encodeURIComponent(days)}`);
...
export const extraerPortalClienteSolicitudDocumento = (data) => apiFetch("/portal-cliente/solicitudes/documento/extraer", { method:"POST", body:data, silentSuccess:true });
