...
const S = {
  ...
  kickerDark: { display:"inline-flex", color:"var(--accent)", fontWeight:900, fontSize:13, textTransform:"uppercase", letterSpacing:0, marginBottom:10 },
  ...
  planFeatured: { border:"2px solid var(--accent)", boxShadow:"0 18px 35px rgba(15,118,110,.16)" },
  ...
  badge: { background:"var(--accent)", color:"#fff", borderRadius:8, padding:"4px 8px", fontSize:12, fontWeight:900 },
