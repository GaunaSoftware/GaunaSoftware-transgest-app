...
const MODULOS_GERENTE = [
  { titulo:"Principal", items:[
    ...
    { id:"agenda", icon:IC.cuadrante, label:"Agenda" },
  ]},
  { titulo:"Operaciones", items:[
    { id:"gestion_trafico", icon:IC.vehiculos, label:"Gestion de Trafico" },
    { id:"control_tower", icon:IC.rendimiento, label:"Control Tower" },
    { id:"copiloto_operativo", icon:IC.dashboard, label:"Copiloto operativo" },
    ...
    { id:"palets", icon:IC.docs, label:"Gestion de Almacen" },
    { id:"calculador_portes", icon:IC.facturacion, label:"Calculador de Portes" },
  ...
  { titulo:"Gestion", items:[
    ...
    { id:"actividad", icon:IC.docs, label:"Registro de actividad" },
    { id:"importacion", icon:IC.docs, label:"Importacion" },
  ]},
];
...
const GUIDED_MODULE_LABELS = {
  ...
  gestion_trafico: "Gestion de Trafico",
