...
const accountingIntegrationCatalog = [
  ...
  },
  {
    ...
    connector: "Exportacion fiscal/contable validada con asesoria; API solo con contrato partner",
    flows: ["facturas emitidas", "facturas recibidas", "terceros", "asientos", "documentos fuente"],
    source_url: "https://www.wolterskluwer.com/es-es/solutions/a3innuva",
    risk: "No asumir API abierta en produccion: confirmar formato de importacion, series, impuestos, cuentas y adjuntos con asesor/partner Wolters Kluwer.",
  },
  {
    id: "holded",
    name: "Holded",
  ...
  },
  {
    ...
    connector: "Excel/CSV/TXT segun plantilla de importacion de la version instalada",
    flows: ["facturas", "terceros", "asientos", "cobros/pagos", "documentos fuente"],
    source_url: "https://www.sdelsol.com/programa-contabilidad-contasol/",
    risk: "FACTUSOL/CONTASOL suelen depender de importadores y version local/nube: validar plantillas reales antes de activar automatismos.",
  },
  {
    id: "odoo",
    name: "Odoo",
