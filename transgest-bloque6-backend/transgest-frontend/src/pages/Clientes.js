              ...
              <tr key={c.id}
                style={{
                  ...
                  background: c.pendiente_revision
                    ? "rgba(251,191,36,.06)"
                    : "transparent",
                  borderLeft: c.pendiente_revision
                    ? "3px solid #f59e0b"
                ...
                <td style={S.td} onClick={e=>e.stopPropagation()}>
                  <div style={{display:"flex",gap:6,flexWrap:"wrap"}}>
                    ...
                    {c.pendiente_revision && canEdit && (
                      <button style={{...S.btn,background:"rgba(16,185,129,.1)",color:"#10b981",padding:"4px 10px",fontSize:11,border:"1px solid rgba(16,185,129,.25)"}}
                        onClick={async e=>{
                          e.stopPropagation();
                    ...
                    {canEdit && <button style={{...S.btn,background:"rgba(240,82,82,.1)",color:"#f05252",padding:"4px 10px",fontSize:11}} onClick={()=>eliminar(c)}>Eliminar</button>}
                  </div>
                </td>
              </tr>
            ))}
